...
router
  .route('/:id')
  .get(validate(contactValidation.getFeedback), contactController.getFeedback)
  .patch(validate(contactValidation.updateFeedback), contactController.updateFeedback);
